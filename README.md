...
Ensure you have [added the path variable](https://github.com/ministryofjustice/hmpps-community-payback-api/tree/main/tools/cp-stack#running) `LOCAL_CP_SUI_PATH` with a link to your clone of this repository.
