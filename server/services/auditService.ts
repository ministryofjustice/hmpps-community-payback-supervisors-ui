...
export enum Page {
  ...
  SHOW_NEXT_SESSIONS_PAGE = 'SHOW_NEXT_SESSIONS_PAGE',
  ...
  SHOW_APPOINTMENT_ARRIVED_END_TIME_PAGE = 'SHOW_APPOINTMENT_ARRIVED_END_TIME_PAGE',
  SUBMIT_APPOINTMENT_ARRIVED_END_TIME_PAGE = 'SUBMIT_APPOINTMENT_ARRIVED_END_TIME_PAGE',
  ...
  SHOW_APPOINTMENT_LEFT_EARLY_REASON_PAGE = 'SHOW_APPOINTMENT_LEFT_EARLY_REASON_PAGE',
  SUBMIT_APPOINTMENT_LEFT_EARLY_REASON_PAGE = 'SUBMIT_APPOINTMENT_LEFT_EARLY_REASON_PAGE',
  COOKIES_POLICY_PAGE = 'COOKIES_POLICY_PAGE',
  PRIVACY_NOTICE_PAGE = 'PRIVACY_NOTICE_PAGE',
  ACCESSIBILITY_STATEMENT_PAGE = 'ACCESSIBILITY_STATEMENT_PAGE',
  REVIEW_APPOINTMENT_ABSENT_PAGE = 'REVIEW_APPOINTMENT_ABSENT_PAGE',
  REVIEW_APPOINTMENT_UNABLE_TO_WORK_PAGE = 'REVIEW_APPOINTMENT_UNABLE_TO_WORK_PAGE',
  REVIEW_APPOINTMENT_COMPLETED_COMPLIANCE_PAGE = 'REVIEW_APPOINTMENT_COMPLETED_COMPLIANCE_PAGE',
  REVIEW_APPOINTMENT_LEFT_EARLY_COMPLIANCE_PAGE = 'REVIEW_APPOINTMENT_LEFT_EARLY_COMPLIANCE_PAGE',
}
