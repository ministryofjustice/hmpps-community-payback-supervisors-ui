    ...
    it('should return an object with correct data', () => {
      ...
      expect(result).toEqual({
        ...
        actions: [
          {
            text: 'Arrived',
            path: paths.appointments.arrived.startTime({ projectCode, appointmentId: id.toString() }),
          },
          {
            text: 'Not arrived',
            path: paths.appointments.absent.startTime({ projectCode, appointmentId: id.toString() }),
          },
        ],
        statusTagHtml,
      })
